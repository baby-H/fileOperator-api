...
import cn.huyingjie.grabticket.util.ResultUtil;
...
@RestController
@Api(value = "FileController", description = "文件操作", tags = "用户")
@RequestMapping("/file")
public class FileController {
    private static final Logger logger = LoggerFactory.getLogger(FileController.class);
    //在文件操作中，不用/或者\最好，推荐使用File.separator
    private final static String fileDir = "files";
    String t = System.getProperty("user.home") + File.separator;
    private final static String rootPath = fileDir + File.separator;

    @ApiOperation(value = "上床文件", notes = "无")
    @ApiImplicitParams({
