...
public class SlaveDataSourceConfig {
    ...
    static final String PACKAGE = "cn.huyingjie.grabticket.mapper.slave";
    static final String MAPPER_LOCATION = "classpath:cn/huyingjie/grabticket/mapper/slave/*.xml";
